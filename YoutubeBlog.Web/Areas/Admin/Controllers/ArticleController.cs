...
namespace YoutubeBlog.Web.Areas.Admin.Controllers
{
    ...
    public class ArticleController : Controller
    {
        ...
        {
            var map=mapper.Map<Article>(articleAddDto); //dto nesnesini varlık nesnesine dönüştürdüm.
            var result=await validator.ValidateAsync(map); //yeni varlık nesnesini doğruladım.
            if(result.IsValid)
            {
